...
public:
    ...
    constexpr explicit operator SIG_UINT_T() const noexcept { return static_cast<SIG_UINT_T>(m_d); }

    constexpr explicit operator SIG_SINT_T() const noexcept { return static_cast<SIG_SINT_T>(m_d); }
    /// dig_t<10> a{3};
    /// a()->3 (como uint)
...
public:
  ////////////////////////////////////////////////////////////////////////////
    static consteval bool is_prime() noexcept
    {
    return auxiliary_functions::is_prime(static_cast<std::size_t>(B));
    }
  ////////////////////////////////////////////////////////////////////////////
    static consteval dig_t dig_max() noexcept { return dig_t(B - 1u); };
    static consteval dig_t dig_submax() noexcept { return dig_t(B - 2u); }
    static consteval dig_t dig_Bm1() noexcept { return dig_t(B - 1u); }
    static consteval dig_t dig_Bm2() noexcept { return dig_t(B - 2u); }
    static consteval dig_t dig_0() noexcept { return dig_t(); }
    static consteval dig_t dig_1() noexcept { return dig_t(1u); }
    ////////////////////////////////////////////////////////////////////////////
    static consteval UINT_T ui_max() noexcept { return UINT_T(B - 1u); }
    static consteval UINT_T ui_submax() noexcept { return UINT_T(B - 2u); }
    static consteval UINT_T ui_Bm1() noexcept { return UINT_T(B - 1u); }
    static consteval UINT_T ui_Bm2() noexcept { return UINT_T(B - 2u); }
    static consteval UINT_T ui_0() noexcept { return UINT_T(0u); }
    static consteval UINT_T ui_1() noexcept { return UINT_T(1u); }
    ////////////////////////////////////////////////////////////////////////////
    static consteval SIG_UINT_T sui_B() noexcept { return static_cast<SIG_UINT_T>(B); }
    static consteval SIG_UINT_T sui_max() noexcept { return static_cast<SIG_UINT_T>(B - 1u); }
    static consteval SIG_UINT_T sui_submax() noexcept { return static_cast<SIG_UINT_T>(B - 2u); }
    static consteval SIG_UINT_T sui_0() noexcept { return static_cast<SIG_UINT_T>(0u); }
    static consteval SIG_UINT_T sui_1() noexcept { return static_cast<SIG_UINT_T>(1u); }
    ////////////////////////////////////////////////////////////////////////////
    static consteval SIG_SINT_T ssi_B() noexcept { return static_cast<SIG_SINT_T>(B); }
    static consteval SIG_SINT_T ssi_max() noexcept { return static_cast<SIG_SINT_T>(B - 1u); }
    static consteval SIG_UINT_T ssi_submax() noexcept { return static_cast<SIG_SINT_T>(B - 2u); }
    static consteval SIG_UINT_T ssi_0() noexcept { return static_cast<SIG_SINT_T>(0u); }
    static consteval SIG_UINT_T ssi_1() noexcept { return static_cast<SIG_SINT_T>(1u); }
    ////////////////////////////////////////////////////////////////////////////
...
private:
  ...
  ///< TENIENDO EN CUENTA TIPOS Y SIGNOS
    ...
    constexpr static UINT_T normaliza(Int_t arg) noexcept
    {
...
public:
  ...
  /// EN m_d SOLO QUEREMOS QUE HAYA UN NUMERO ENTRE 0 Y B-1 INCLUSIVES
    template<type_traits::integral_c Int_t>
    constexpr dig_t(Int_t arg) noexcept
